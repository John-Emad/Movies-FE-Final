...
export class AllSeriesPage {
    ...
    constructor() {
        ...
        this.paginationContainer = document.getElementById('pagination') as HTMLElement;
    ...
    private async loadSeries(page: number): Promise<void> {
    ...
    private renderSeries(seriesList: any[]): void {
